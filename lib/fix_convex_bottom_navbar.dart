...
class ConvexBottomNavigationFix extends StatefulWidget {
  ///Constructor
  ...
  final List<BoxShadow> barShadowList;

  @override
  ConvexBottomNavigationFixState createState() => ConvexBottomNavigationFixState();
}

///Class ConvexBottomNavigationState
///It controls the ConvexBottomNavigation state
class ConvexBottomNavigationFixState extends State<ConvexBottomNavigationFix>
  ...
  void didChangeDependencies() {
    ...
    barShadowList = widget.barShadowList;
  }
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        Container(
          height: BAR_HEIGHT,
          decoration: BoxDecoration(color: barBackgroundColor, boxShadow: barShadowList,),
          child: Row(
